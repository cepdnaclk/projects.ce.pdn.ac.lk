...
for p in projects:
    ...
    projects[p]['project_url'] = projects[p]['project_url'].replace(
...
sorted_list = sorted(filtered_list, key=itemgetter(
    'popularity_score'), reverse=True)
...
result = {sliced_list[i]['name']: sliced_list[i]
