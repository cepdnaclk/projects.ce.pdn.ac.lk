...
description: The project 'History of Music' is a ML based project. In this project
  we expect to build a model to express how a piece of music evolved from various
  genres.
has_children: false
